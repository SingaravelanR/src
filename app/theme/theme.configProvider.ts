    ...
    this.conf = {
      ...
      colors: {
        ...
        dashboard: {
		  ...
		  violet: this.dashboardColors.violet,
        },

        custom: {
          dashboardPieChart: colorHelper.shade(this.dashboardColors.surfieGreen, 0.8),
          dashboardLineChart: this.dashboardColors.surfieGreen,
        }
      }
    };
  }
